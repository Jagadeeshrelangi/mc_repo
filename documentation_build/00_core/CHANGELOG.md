...
- **Independent engineering audit** (read-only) of the full repo: frontend,
  ...
  Report archived at `documentation_build/archive/engineering_review/ENGINEERING_REVIEW_REPORT.md`.
...
- Timeline (2026-07-20 → 2026-08-05) re-verified against `CHANGELOG.md` + git;
  the `documentation_build/00_core/PROJECT_TIMELINE.md` 12-month narrative

# Module Knowledge: Mechanic (`lib/features/mechanic/`)

> Phase 5 · Entry via Services tab. Source: FRONTEND_ARCHITECTURE §5.3, API_CONTRACT §6, FEATURE_SPECIFICATIONS §5.

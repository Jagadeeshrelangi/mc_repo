...
| Folder structure | `folder_structure.mmd` | `lib/` tree with per-module counts |
...
> All diagrams grounded in `FRONTEND_ARCHITECTURE.md`, `NAVIGATION_MAP.md`,
> `DATABASE_BLUEPRINT.md`, `API_CONTRACT.md` and the Phase 1 repo scan.

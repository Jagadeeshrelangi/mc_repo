...
**Version:** 1.9.3-docs (RC1 · Frontend Lock Candidate) | **Last Updated:** 2026-08-06
...
```
> Historical sprint/QA reports are archived under
> [`documentation_build/archive/`](../documentation_build/archive/).
...
| `documentation_build/archive/` | Historical sprint/QA reports (was `05_reports/`) | Historical |
...
4. Completed-sprint/QA reports are archived under
   [`documentation_build/archive/`](../documentation_build/archive/) (the old
   `docs/05_reports/` folder was retired in the Pre-Sprint 2 cleanup).

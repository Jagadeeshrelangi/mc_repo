...
> Phase 3 · Frozen contract for the in-memory repositories (`API_CONTRACT.md`), which the real
...
Orders-tab integration: `addMarketplaceOrder(...)` in `lib/parts/order_data.dart` inserts a `parts` entry

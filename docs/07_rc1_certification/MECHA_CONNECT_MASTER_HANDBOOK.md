...
- `docs/01_product/*` — PRD, business model, feature specs, roadmap, risk
  analysis (planning source material)
- `docs/03_development/*` — changelog, contributing, test plan, installation,
  deployment
- `docs/05_reports/*` — sprint reports
...
| 1.0 | — | Original engineering handbook (archived as `docs/archive/MASTER_ENGINEERING_HANDBOOK_v1.0.md`) |

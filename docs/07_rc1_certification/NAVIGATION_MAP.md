...
|---|---|---|---|
| 0 | Home | `HomeDashboard` | `lib/starting_screen/home.dart` |
...
Route constants live in `lib/features/mechanic/`; screens in
`lib/features/mechanic/screens/`.
...
Route constants + helper in `lib/features/ai/navigation.dart`:
...
Route constants + fade helpers in `lib/features/profile/navigation.dart`

...
| **File** | `frontend/lib/Starting_screen/screens.dart` |
...
| **Priority** | P0 |
| **Status** | ✅ Done (Sprint 1.2) |
| **File** | `frontend/lib/Auth/screens/` |
...
| **File** | `frontend/lib/home/home_screen.dart` |
...
| **Files** | `frontend/lib/mechanic/` (9 screens, 7 widgets) |
...
| **File** | `frontend/lib/vehicle_service/` |
...
| **Files** | `frontend/lib/core/utils/responsive.dart`, `ConstrainedContent` widget |
...
| **Files** | `frontend/lib/parts/parts_screen.dart`, `frontend/lib/parts/cart_screen.dart`, `frontend/lib/parts/order_data.dart` |

...
# Install Flutter dependencies (from frontend/)
cd frontend
flutter pub get
...
7. Write the sprint record to `docs/archive/sprint_history/`
8. Update canonical docs: `docs/handbook/CHANGELOG.md` and `docs/common/PROJECT_STATUS.md`
...
- **Reusable shared widgets** in `frontend/lib/widgets/`
- **Mock data** until Sprint 2 (backend)

---

## Related Documents
- [Architecture.md](../frontend/Architecture.md) (architecture blueprint)
- [Design_System.md](../frontend/Design_System.md) (theme tokens)
- [Testing.md](../frontend/Testing.md) (testing guidelines)
- [Deployment.md](../backend/Deployment.md) (build commands)

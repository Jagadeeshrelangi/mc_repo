...
The full authoritative list lives in `frontend/pubspec.yaml` / `frontend/pubspec.lock`.
...
The public handbook (`docs/handbook/ENGINEERING_HANDBOOK.md` and its renders)
is **Public** project material (see `COPYRIGHT_NOTICE.md`). Internal
renderers, business materials, and audits are **Internal / Confidential** and

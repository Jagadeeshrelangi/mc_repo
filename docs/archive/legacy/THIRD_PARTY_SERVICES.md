...
|---------|---------|-------------|--------|------|----------|
| **Gemini API** | AI diagnosis from symptoms | HTTP via `lib/core/services/ai_service.dart` | ✅ Active | Paid tier (see internal financials) | Regex keyword matching + cached responses |

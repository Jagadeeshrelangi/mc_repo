...
- Every screenshot maps to a Handbook chapter for figure placement (see `../../Assets.md`).
...
2. Navigate to each screen via the flows in `../../Navigation.md` and `../navigation/route_maps.md`.
3. Capture light mode; capture dark variant for Home dashboard, Product detail, and any
   screen with dark-token risk (see `../Design_System.md` §6).

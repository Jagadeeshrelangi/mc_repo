...
- `frontend/lib/mechanic/mock_data/mock_data.dart`
- `frontend/lib/vehicle/mock_data/`
...
- [PROJECT_STATUS.md](../common/PROJECT_STATUS.md)
- [FEATURE_SPECIFICATIONS.md](../common/FEATURE_SPECIFICATIONS.md)

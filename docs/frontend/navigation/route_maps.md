...
> Phase 3 · Source: `../Navigation.md` (frozen) + repo scan of `navigation.dart`.
...
|---|---|---|
| 0 Home | `HomeDashboard` | `frontend/lib/starting_screen/home.dart` (legacy path in NAVIGATION_MAP) |
...
- **AI** (`frontend/lib/features/ai/navigation.dart`): `/ai`, `/ai/chat`, `/ai/diagnosis`, `/ai/history`, `/ai/conversation`
- **Marketplace** (`frontend/lib/features/marketplace/navigation.dart`): `/marketplace`, `/marketplace/product`, `/marketplace/category`, `/marketplace/search`, `/marketplace/cart`, `/marketplace/wishlist`
- **Profile** (`frontend/lib/features/profile/navigation.dart`): `/profile`, `/profile/edit`, `/profile/vehicles`, `/profile/vehicles/detail`, `/profile/addresses`, `/profile/wallet`, `/profile/rewards`, `/profile/orders`, `/profile/notifications`, `/profile/privacy`, `/profile/support`, `/profile/about`
